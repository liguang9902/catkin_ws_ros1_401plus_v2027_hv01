...
class ros_set_iap_cmdActionResult {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('result')) {
        ...
        this.result = new ros_set_iap_cmdResult();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ros_set_iap_cmdResult.serialize(obj.result, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ros_set_iap_cmdActionResult(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [status]
    data.status = actionlib_msgs.msg.GoalStatus.deserialize(buffer, bufferOffset);
    // Deserialize message field [result]
    data.result = ros_set_iap_cmdResult.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ros_set_iap_cmdActionResult(null);
    ...
    if (msg.result !== undefined) {
      resolved.result = ros_set_iap_cmdResult.Resolve(msg.result)
    }
    else {
      resolved.result = new ros_set_iap_cmdResult()
    }
...
module.exports = ros_set_iap_cmdActionResult;
