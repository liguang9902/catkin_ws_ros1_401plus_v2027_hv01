...
class ros_set_iap_cmdActionGoal {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('goal')) {
        ...
        this.goal = new ros_set_iap_cmdGoal();
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    bufferOffset = ros_set_iap_cmdGoal.serialize(obj.goal, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    let len;
    let data = new ros_set_iap_cmdActionGoal(null);
    // Deserialize message field [header]
    data.header = std_msgs.msg.Header.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal_id]
    data.goal_id = actionlib_msgs.msg.GoalID.deserialize(buffer, bufferOffset);
    // Deserialize message field [goal]
    data.goal = ros_set_iap_cmdGoal.deserialize(buffer, bufferOffset);
    return data;
  }
  ...
  static md5sum() {
    ...
    return 'c47dfcde8719996f237660fc6dadc6c7';
  }
  ...
  static Resolve(msg) {
    ...
    const resolved = new ros_set_iap_cmdActionGoal(null);
    ...
    if (msg.goal !== undefined) {
      resolved.goal = ros_set_iap_cmdGoal.Resolve(msg.goal)
    }
    else {
      resolved.goal = new ros_set_iap_cmdGoal()
    }
...
module.exports = ros_set_iap_cmdActionGoal;
