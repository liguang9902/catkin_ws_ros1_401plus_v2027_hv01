...
"""autogenerated by genpy from segway_msgs/ros_set_iap_cmdActionResult.msg. Do not edit."""
import codecs
import sys
...
class ros_set_iap_cmdActionResult(genpy.Message):
  _md5sum = "7d50b94e130018208367952990b49ff7"
  _type = "segway_msgs/ros_set_iap_cmdActionResult"
...
"""
  ...
  _slot_types = ['std_msgs/Header','actionlib_msgs/GoalStatus','segway_msgs/ros_set_iap_cmdResult']
  ...
  def __init__(self, *args, **kwds):
    ...
    """
    if args or kwds:
      super(ros_set_iap_cmdActionResult, self).__init__(*args, **kwds)
      ...
      if self.result is None:
        self.result = segway_msgs.msg.ros_set_iap_cmdResult()
    else:
      self.header = std_msgs.msg.Header()
      self.status = actionlib_msgs.msg.GoalStatus()
      self.result = segway_msgs.msg.ros_set_iap_cmdResult()
  ...
  def serialize(self, buff):
    ...
    try:
      ...
      buff.write(struct.Struct('<I%ss'%length).pack(length, _x))
      _x = self
      buff.write(_get_struct_2h().pack(_x.result.iap_result, _x.result.error_code))
  ...
  def deserialize(self, str):
    ...
    try:
      ...
      (_x.result.iap_result, _x.result.error_code,) = _get_struct_2h().unpack(str[start:end])
      return self
